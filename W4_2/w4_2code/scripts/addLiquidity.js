...
async function main() {
    ...
    const myTokenMarket = await ethers.getContractAt("MyTokenMarket", "0xf101033c7875213c33A8288fBE2232C08afaF23f", account);
    const myToken = await ethers.getContractAt("MyToken", "0x54A51a039e7151dB37518b201A6aadD4A14CA29d", account);
    const myTokenTx = await myToken.approve("0xf101033c7875213c33A8288fBE2232C08afaF23f", "10000000000000000000000000000000000");
